...
public class FoodCalorieListAdapter extends BaseAdapter {
    ...
    private Context mContext;
        ...
        public FoodCalorieListAdapter(Context context, List<Food> list) {
            super();
            this.list = list;
            mContext=context;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
          ...
          //  holder.tv_cal.setText(myOrder.num+"毫克");
            ...
            holder.tv_stu_type.setText( myOrder.kcal+"Kcal/"+myOrder.num+"g");
